...
remera=Prenda.create! descripcion: "remera para dormir", material: :algodon, color_primario: :rojo, guardarropa_id: 1, prenda_tipo_id: 1
pantalon=Prenda.create! descripcion: "pantalon para dormir", material: :lino, color_primario: :blanco, color_secundario: :gris, guardarropa_id: 1, prenda_tipo_id: 1
